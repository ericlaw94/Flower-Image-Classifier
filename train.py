...
parser.add_argument('--dropout', help = "Set dropout rate , default = 0.2", default = 0.2,type = float)
...
input_sizes = {'vgg19' : 25088 , 'densenet121': 1024}
classifier = nn.Sequential(OrderedDict([ 
    ('hidden1',nn.Linear(input_sizes[arg.arch], arg.hidden_units)),
    ('relu',nn.ReLU()),
    ('dropout', nn.Dropout(arg.dropout)),
    ('hidden2', nn.Linear(arg.hidden_units, len(image_datasets['train_data'].class_to_idx))),
...
checkpoint = arg.save_dir 
    
model.class_to_idx = image_datasets['train_data'].class_to_idx
checkpoint = {'model': arg.arch,
              'output': len(image_datasets['train_data'].class_to_idx),
